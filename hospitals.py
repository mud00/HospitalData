...
dataset_name = " Localisation des hôpitaux dans OpenStreetMap"
...
page = st.sidebar.radio("Go to", ["Home", "Our Goal"])
...
if page == "Home":
    ...
    st.write("\n\n")
    st.write("**Map of French Healthcare Institutions, sorted by specialties and facilities**")
    ...
    # Code for the "Our Goal" page
    st.subheader("Our Goal")
    st.write("This application aims to provide valuable insights into healthcare institutions in France and their specialties.")
    st.write("By offering information on healthcare facilities across the country, the application enables users to gain a deeper understanding of the nationwide healthcare landscape.")
    st.write("This comprehensive data allows users to identify specific healthcare specialties and assess the corresponding demand or need in different regions of France.")
    st.write("Whether you want to understand the distribution of specialized hospitals, rehabilitation centers, or other healthcare facilities, our application offers a rich source of information to help answer your questions and provide insights into the healthcare system in France.")
